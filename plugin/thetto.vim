...
if get(g:, 'thetto_debug', v:false)
    command! -nargs=* Thetto lua require("thetto/cleanup")("thetto"); require("thetto/entrypoint/command").open(<f-args>)
    command! -nargs=* -complete=custom,thetto#complete#action ThettoDo lua require("thetto/cleanup")("thetto"); require("thetto/entrypoint/command").execute(<f-args>)
else
