...
if get(g:, 'thetto_debug', v:false)
    command! -nargs=* -complete=custom,thetto#complete#source Thetto lua require("thetto/lib/module").cleanup("thetto"); require("thetto/entrypoint/command").start_by_excmd({<f-args>})
    ...
    command! -nargs=* -complete=custom,thetto#complete#source Thetto lua require("thetto/entrypoint/command").start_by_excmd({<f-args>})
